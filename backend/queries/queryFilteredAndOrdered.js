...
module.exports = async function queryFilteredAndOrdered(req,res,schemaName,tableName,viewName) {
...
queryCols Variable >>> ${allowCols}`
    ...
    try {
        ...
        let query = knex.select(select).from(schemaName + '.' + viewName);
